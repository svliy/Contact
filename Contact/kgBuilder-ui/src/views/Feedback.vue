...
<!--        </div>-->
<!--        <div class="fr">-->
<!--          &lt;!&ndash;          <a href="javascript:void(0)" @click="showJsonData" class="svg-a-sm">&ndash;&gt;-->
<!--          &lt;!&ndash;            <i class="el-icon-tickets">查看数据</i>&ndash;&gt;-->
<!--          &lt;!&ndash;          </a>&ndash;&gt;-->

<!--          <a href="javascript:void(0)" @click="saveImage" class="svg-a-sm">-->
<!--            <i class="el-icon-camera-solid">截图</i>-->
<!--          </a>-->
<!--          &lt;!&ndash;          <a href="javascript:void(0)" @click="importGraph" class="svg-a-sm">&ndash;&gt;-->
<!--          &lt;!&ndash;            <i class="el-icon-upload">导入</i>&ndash;&gt;-->
<!--          &lt;!&ndash;          </a>&ndash;&gt;-->
...
<!--          </a>-->
<!--          &lt;!&ndash;          <a href="javascript:void(0)" @click="help" class="svg-a-sm">&ndash;&gt;-->
<!--          &lt;!&ndash;            <i class="el-icon-info">帮助</i>&ndash;&gt;-->
<!--          &lt;!&ndash;          </a>&ndash;&gt;-->
<!--          &lt;!&ndash;          <a href="javascript:void(0)" @click="wanted" class="svg-a-sm">&ndash;&gt;-->
<!--          &lt;!&ndash;            <i class="el-icon-question">反馈</i>&ndash;&gt;-->
<!--          &lt;!&ndash;          </a>&ndash;&gt;-->
<!--        </div>-->
<!--      </div>-->
<!--      &lt;!&ndash; 头部over &ndash;&gt;-->
...
<!--    </div>-->
    ...
    <el-container>
      <el-main style="height: 85vh;background-color: white;border: 1px solid purple;border-radius: 10px;margin: 10px">
        <el-row :gutter="20">
          <el-col :span="12">
              <el-card class="box-card" shadow="hover" style="margin-top: 10px">
                <el-row>
                  <el-col :span="6">  <h2>精选反馈</h2></el-col>
                  <el-col :span="6" :offset="12">
                    <el-dialog :visible.sync="dialogFormVisible">
                      <el-form ref="form" :model="form" label-width="80px">
                        <el-form-item label="图谱ID">
                          <el-input v-model="form.domainId"></el-input>
                        </el-form-item>
                    ...
                    <el-button type="primary" size="small" @click="fdback(val)">反馈</el-button>
                  </el-col>
                </el-row>
                <div class="block">
                  <el-timeline>
                    <el-timeline-item v-for="(feedBack,i) in feedbacklist" :timestamp="feedBack.time | fliter2" placement="top">
                      <el-card>
                        <h4>{{feedBack.content}}</h4>
                        <p>{{feedBack.name}} 提交于 {{feedBack.time | fliter3}}</p>
                      </el-card>
                    </el-timeline-item>
<!--                    <el-timeline-item timestamp="2018/4/3" placement="top">-->
<!--                      <el-card>-->
<!--                        <h4>更新 Github 模板爱看电视饭卡就是离开房间临时卡</h4>-->
...
<!--                    </el-timeline-item>-->
          ...
          <el-col :span="12">
            <el-card class="box-card-1" shadow="hover" style="margin-top: 10px">
...
export default {
  ...
  data() {
    return {
      feedbacklist: [
        {content: '暂无反馈', name: '管理员', time:'2022/1/1'},
      ],
      form: {
        domainId: '',
        userId: '',
  ...
  methods: {
    onSubmit() {
      ...
      this.form.userId = localStorage.getItem("user")
        ...
        : ""
      console.log(this.form)
      contactApi.addFeedBack(this.form).then((res) => {
        if (res) {
          // 弹出提示
    ...
    matchDomainGraph(domain) {
      this.tupuname = domain.name
      this.domain = domain.name;
      this.domainId = domain.id;
      this.getDomainGraph();
      this.getFeedBackList(this.domainId);
    },
    getFeedBackList(val){
      contactApi.getFeedBackList(val).then((res)=>{
        console.log(res)
